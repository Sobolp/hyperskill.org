 ...
 * After calling the count() method it should return the count of prime numbers in the given range. Pay attention to the method template.
 *
 ...
 *
 * Please, be careful with the rangeClosed, iterate and limit methods!
